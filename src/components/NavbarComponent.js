        ...
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="me-auto">
              ...
              <Nav.Link className="text-light px-2" href="/politics">
                Politics
              </Nav.Link>
              <Nav.Link className="text-light px-2" href="/newyork">
                N.Y
              </Nav.Link>
              <Nav.Link className="text-light px-2" href="/business">
                Business
              </Nav.Link>
              <Nav.Link className="text-light px-2" href="/opinion">
                Opinion
              </Nav.Link>
              <Nav.Link className="text-light px-2" href="/tech">
                Tech
              </Nav.Link>
              <Nav.Link className="text-light px-2" href="/science">
                Science
              </Nav.Link>
              <Nav.Link className="text-light px-2" href="/sports">
                Sports
              </Nav.Link>
